'''
inception net code modified from https://www.kaggle.com/code/ivankunyankin/googlenet-inception-from-scratch-using-pytorch/notebook

needs to be adapted to FaceNet model (table 2) structure (using l2 pooling instead of max)
'''
